...
import type { CharacterImageKey as _CharacterImageKey, HomebrewArtKey as _HomebrewArtKey, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async deleteCharacterImage(arg0: CharacterId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteCharacterImage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteHomebrewArt(arg0: HomebrewItemId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteHomebrewArt(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCharacterImageKey(arg0: CharacterId): Promise<CharacterImageKey | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCharacterImageKey(arg0);
    ...
    async getHomebrewArtKey(arg0: HomebrewItemId): Promise<HomebrewArtKey | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getHomebrewArtKey(arg0);
    ...
    async uploadCharacterImage(arg0: CharacterId, arg1: CharacterImageKey): Promise<UploadResult> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadCharacterImage(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadHomebrewArt(arg0: HomebrewItemId, arg1: HomebrewArtKey): Promise<HomebrewArtResult> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadHomebrewArt(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_CharacterImageKey]): CharacterImageKey | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_HomebrewArtKey]): HomebrewArtKey | null {
    return value.length === 0 ? null : value[0];
}
